            ...
            >
              ...
              >
                <div
                  ...
                  className={`absolute bottom-0 z-[2] m-6 flex cursor-pointer items-center rounded-full bg-white text-[16px] font-bold`}
                >
                  <svg
                      ...
                      <div className={`ml-[-14px] flex items-center`}>
                        ...
                        >
                          ...
                          style={{
                            ...
                            width: 20,
                            height: 20,
                            backgroundImage: `url("https://s.pinimg.com/webapp/reactionHeartOutline-24ab75a6.svg")`,
                          }}
                        ></div> */}
                          <svg
