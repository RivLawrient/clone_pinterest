              ...
              >
                ...
                >
                  ...
                  <img
                    ...
                    className={`z-[1] select-none ${detail ? "opacity-0" : ""} rounded-l-[32px] object-cover`}
                  />
                  {/* )} */}
                </div>
                {width > 0 && (
                  <div
                    ...
                    className={`relative flex flex-col overflow-hidden rounded-r-[32px] p-8 py-3 shadow-[rgba(0,0,0,0.1)_0px_0px_8px_0px]`}
                  >
                    {post && (
